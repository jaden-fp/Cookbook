...
const MIXING_PUNS = [
  ...
  "Why did the baker go to therapy? Too many emotional layers.",
  "I told my dough a joke. It didn't rise to the occasion.",
  "Why don't bakers tell secrets? Too many leaks in the batter.",
  "What did the flour say to the butter? 'You make me melt.'",
  "Why was the whisk sad? It kept getting beaten.",
  "What do you call a sleeping baker? A roll model.",
  "Why did the muffin refuse to talk? It was on a roll.",
  "What's a baker's favorite math? Pie.",
  "I tried to make a belt out of bread. Waist of dough.",
  "Why did the croissant break up with the baguette? Too flaky.",
  "What do you call an angry baker? Someone who really kneads to chill.",
  "Why did the cake go to school? To get a little batter.",
  "I burned my Hawaiian pizza. Should've used aloha temperature.",
  "What's a ghost's favorite dessert? Boo-berry muffins.",
];

// Stage 1: Oven (33–67%)
const BAKING_PUNS = [
  "Why did the oven break up with the stove? It needed space.",
  "What did one oven say to the other? 'You're so hot right now.'",
  "Why don't ovens ever win at poker? They always show their hand.",
  "What did the bread say in the oven? 'It's getting a little hot in here.'",
  "Why was the loaf so stressed? It had too much on its plate.",
  "What do you call a loaf that's full of itself? Upper crust.",
  "Why did the sourdough get an award? Outstanding in its field.",
  "How does bread propose? 'I loaf you so much.'",
  "Why did the bagel go to the gym? To get a little more well-rounded.",
  "What do you call bread that's a good listener? Comprehensive rye.",
  "Why did the biscuit go to school? To get a little flakier.",
  "What's a baker's least favorite movie? Anything with a bad roll model.",
  "Why did the brownie win the election? It had great fudge factor.",
  "What do you call a fast bread? Scone in a flash.",
  "Why did the oven get promoted? It always delivered.",
  "What do you call bread that believes in itself? Gluten for punishment.",
];

// Stage 2: Decorating / Finishing (67–100%)
const DECORATING_PUNS = [
  "Why did the cake go to the party alone? It was already a tier.",
  "What do you call a sad cake? A layer of regret.",
  "Why did the frosting get in trouble? It spread too many rumors.",
  "What do you call a well-dressed cake? Frosting the impression.",
  "Why did the cupcake go to school? To get a little more icing on the diploma.",
  "What do bakers put on their sandwiches? Lots of self-raising bread.",
  "Why did the sprinkles go to therapy? They couldn't handle the pressure.",
  "What's a baker's favorite TV show? Batter Call Saul.",
  "Why did the cake get a standing ovation? It really rose to the occasion.",
  "What do you call a pastry that tells jokes? A pun-cake.",
  "Why did the pie go to the dentist? It had too many sweet tooths.",
  "What do you call a cake that's always right? A smartie pants cake.",
  "Why did the eclair apply for a job? It wanted to get glazed over.",
  "What do you call a cake that lifts weights? A buns of steel cake.",
  "Why was the birthday cake so good at sports? It had great tiers.",
  "What do bakers say when they finish? 'That's a wrap — a crêpe, specifically.'",
];
