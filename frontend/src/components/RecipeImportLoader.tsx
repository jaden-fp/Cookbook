...
const MIXING_PUNS = [
  "Whisking the internet for your recipe…",
  "Sifting through the web, three times as directed.",
  "Creaming the butter and sugar — this step is non-negotiable.",
  "Zero lumps. Zero tolerance. Zero exceptions.",
  "Folding, not stirring. We know the difference.",
  "The gluten is developing right on schedule.",
  "Two eggs, room temperature. We asked nicely.",
  "Autolyse phase complete. The flour is thinking.",
  "Measuring by weight, not volume. We're professionals.",
  "The dough isn't sticky. It's just emotionally clingy.",
  "Soft peaks… medium peaks… stiff peaks incoming.",
  "The batter is ribboning off the spatula. Textbook.",
  "Brown butter achieved. The nutty aroma is indescribable.",
  "Sugar granules fully dissolved. Trust the process.",
  "Resting the dough because it genuinely earned it.",
  "Window-pane test passed. Gluten is cooperating.",
  "Bench flour applied. Situation under control.",
  "Kneading your request into something beautiful.",
  "Our mise en place is immaculate. Truly.",
  "The butter was cold. As it should be.",
  "Brioche we could move faster, we really would.",
  "One part patience, two parts flour. Always.",
];

// Stage 1: Oven (33–67%)
const BAKING_PUNS = [
  "Preheated to the exact temperature. Not ±25°.",
  "The Maillard reaction has entered the chat.",
  "Do. Not. Open. The oven door.",
  "Golden brown is a vibe, not a timer setting.",
  "Rotating for even browning. Hot spots are real.",
  "Internal temp says 'almost.' We believe it.",
  "The top has set. The center still has dreams.",
  "Convection on. The fan means business.",
  "We checked once. We checked twice. Still not done.",
  "The toothpick lied. Two more minutes.",
  "That color isn't burning — that's character.",
  "Steam injected. Crust development: underway.",
  "The spring-back test is inconclusive. Patience.",
  "Dutch oven lid coming off in exactly 20 minutes.",
  "Yeast activity detected. Standing back.",
  "The oven smells incredible and so will your recipe.",
  "We'd never half-bake a response. Ever.",
  "48-hour cold ferment? Absolutely worth it.",
  "This one is really proving itself.",
  "A watched oven never browns. We looked away.",
  "Shortbread notice — but we're hustling.",
  "The loaf is scoring beautifully. It's art AND science.",
];

// Stage 2: Decorating / Finishing (67–100%)
const DECORATING_PUNS = [
  "Crumb coat applied. The real frosting begins now.",
  "Ganache cooled to the perfect spreading consistency.",
  "Stars tip loaded. Piping in progress.",
  "The glaze has a 10-second drip. Absolutely ideal.",
  "Final frosting layer: smooth as a well-kept secret.",
  "Sprinkles incoming. Velocity: strategic.",
  "Inverting the cake on three… two…",
  "The springform came off clean. A rare achievement.",
  "Brûlée torch at 30% power. Building up slowly.",
  "Mirror glaze tilted to 45°. Hold. Hold. Hold.",
  "Salt flakes on top. The chef wept one single tear.",
  "No soggy bottom here. Absolutely not.",
  "The crumb structure on this one… *chef's kiss*",
  "Finishing touch applied. This is almost ready.",
  "Adding the sprinkles — and really committing to it.",
  "Sliced cleanly with a hot knife. That's a win.",
  "Edible gold dust: completely unnecessary, completely mandatory.",
  "Your recipe is being presented on a slate board, naturally.",
  "Butter believe this was worth every second.",
  "Getting a little glaze-y with the details…",
  "Ready to reveal what we've been cookie-ing up.",
  "The cake is floating — metaphorically AND literally.",
];
