...
const PUNS = [
  ...
  "Whisking away to fetch your recipe…",
  "Zero lumps allowed in this operation.",
  "Tasting as we go — quality control.",
  "Mise en place? More like mise en PACE.",
  "Tempering the chocolate and our expectations.",
  "We take our resting time seriously around here.",
  "Not all heroes wear capes. Some wear aprons.",
  "Channeling our inner Julia Child right now.",
  "Deglazing the pan… and the situation.",
  "A watched pot never boils. We checked anyway.",
  "Maillard reaction loading… browning nicely.",
  "Laminating the dough. This. Takes. Layers.",
  "Emulsifying the chaos into something beautiful.",
  "Calibrating our digital kitchen scale to 0.01g.",
  "Infusing patience into every single pixel.",
  "Chilling the butter. And ourselves.",
  "The secret ingredient is always more butter.",
  "Consulting the recipe three times for safety.",
  "Torching the top… just for dramatic effect.",
  "Window-pane test passed. Dough is elastic.",
  "Autolyse phase complete. Gluten is cooperating.",
  "Tempering the ganache like an absolute professional.",
  "Scoring the loaf — it's art AND science.",
  "Blooming the gelatin. Patience, patience, patience.",
  "Straining through a fine-mesh sieve. Twice.",
  "Blind baking the crust so you don't have to.",
  "Forty-eight hour cold ferment? Worth it.",
  "We're brûlée-ing this deadline.",
  "Oiling the pan of progress.",
  "Extracting maximum flavor from minimum effort.",
  "Spatchcocking this recipe for efficiency.",
  "Caramelizing the onions of your data. (45 min minimum.)",
  "Rendering the fat. The good kind.",
  "Basting every 30 minutes as instructed.",
  "Just a light drizzle of olive oil… *pours generously*",
  "Dehydrating the wait time.",
  "Vacuum sealing this response for freshness.",
  "Sous vide at exactly 63.5°C. Not 63. Not 64.",
  "Proofing in a warm, draft-free environment.",
  "Rehydrating the dried mushrooms of your patience.",
  "Julienning the timeline.",
  "Chiffonading the results into ribbons of delight.",
  "Brunoise cut. Tiny. Perfect. Ours.",
  "Monter au beurre — finishing with butter, naturally.",
  "Clarifying the butter AND the situation.",
  "Resting the meat of this task for full redistribution.",
  "Slurry added. Sauce thickening beautifully.",
  "Four cups of love, one pinch of hustle.",
  "Leavening your expectations one moment at a time.",
  "Piping bag loaded. Stars tip attached. Ready.",
  "Inverting the cake. Please hold.",
  "Releasing the springform pan on three… two…",
  "Checking internal temp — not done yet.",
  "The toothpick test: inconclusive. Two more minutes.",
  "Golden brown achieved. Patience rewarded.",
  "Rotating the pan for even browning.",
  "Setting the timer and walking away. Bravely.",
  "Napping the plate. (It's a chef thing.)",
  "Quenelling the sorbet of our loading time.",
  "Flambéing purely for the theater of it.",
  "Truffle-shaving this response with care.",
  "Microplaning the zest of your URL.",
  "Steeping the tea of your request.",
  "Pressing the tofu of our thoughts.",
  "Rendering a beautiful result — slowly, lovingly.",
];
